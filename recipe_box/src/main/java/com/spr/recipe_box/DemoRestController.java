...
public class DemoRestController {
    ...
    // Node Endpoint for Recipes
    private String url = "http://13.56.134.63/recipe";
...
//    }
    ...
    @RequestMapping("/make-recipe")
    public String getUser1(@RequestParam(value="user_name") String name) {
        String url = "http://13.56.134.63/retrieve-user?user_name=" + name;
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.getForObject(url, String.class);
    }
